...
ax.plot(x,y,z, color='purple')
      ...
      #plot da Geodesica por caminhos minimos
...
#Estimativa do erro entre a geodesica e o caminho minimo prints
  #Comprimento das geodésicas e do caminho minimo
comp_geod_ida=0
...
print('Erro relativo no comprimento(cm e ida):',(comp_cm-comp_geod_ida)/comp_geod_ida)

print('Erro relativo no comprimento(cm e volta):',(comp_cm-comp_geod_volta)/comp_geod_volta)
print('Erro relativo no comprimento(cm e media):',(comp_cm-comp_geod_media)/comp_geod_media)
print('Erro absoluto no comprimento(volta e media):',comp_geod_volta-comp_geod_media)
print('Erro absoluto no comprimento(ida e media):',comp_geod_ida-comp_geod_media)
